...
export const guide = (
  <div>
    ...
    <p>To setup a full project, I would suggest looking around for tutorials/examples, but I have a sample barebones setup <a href="https://www.overleaf.com/read/thwsxqzcyfwb
      " title="Sample Setup" target="_blank" rel="noopener noreferrer">here</a> that you can copy for a new project of your own.</p>
  </div>
);
